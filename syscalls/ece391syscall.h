...
extern int32_t ece391_modex_vidmap(uint8_t** screen_start);
extern int32_t ece391_song (void);
extern int32_t ece391_show_time(void);
extern int32_t ece391_touch (uint8_t *fname, int32_t bytes);
